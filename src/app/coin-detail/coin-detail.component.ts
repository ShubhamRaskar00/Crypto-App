  ...
  getCoinData(){
    ...
    .subscribe(res=>{
      ...
      if(this.currency === "TWD"){
        res.market_data.current_price.inr = res.market_data.current_price.twd;
        res.market_data.market_cap.inr = res.market_data.market_cap.twd;
      }
      if(this.currency === "PHP"){
        res.market_data.current_price.inr = res.market_data.current_price.php;
        res.market_data.market_cap.inr = res.market_data.market_cap.php;
      }
      if(this.currency === "VND"){
        res.market_data.current_price.inr = res.market_data.current_price.vnd;
        res.market_data.market_cap.inr = res.market_data.market_cap.vnd;
      }
      if(this.currency === "JPY"){
        res.market_data.current_price.inr = res.market_data.current_price.jpy;
        res.market_data.market_cap.inr = res.market_data.market_cap.jpy;
      }
